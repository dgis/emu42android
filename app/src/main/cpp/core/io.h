...
// LCD addresses of Bert Pioneer series without mapping offset
#define BDISP_BEGIN		0x00				// Display begin
#define BDISP_END		0x33				// Display end

// Bert register I/O addresses without mapping offset
#define BSYSTEM_CTRL	0x00				// System Control
#define BCONTRAST		0x01				// LCD Contrast Control
#define BSYSTEM_TEST	0x02				// System Test
#define BMODE			0x03				// Mode register

// 0x00 System Control [TE LBI -- RST]
#define TE				0x08				// Timer Enable
#define BLBI			0x04				// Low Battery Indicator
#define XTRA			0x02				// unused bit
#define RST				0x01				// ReSet

// 0x01 Display contrast [DON DC2 DC1 DC0]
#define DON				0x08				// Display On
#define DC2				0x04				// Display Contrast Bit2
#define DC1				0x02				// Display Contrast Bit1
#define DC0				0x01				// Display Contrast Bit0

// 0x02 System Test [PLEV VDIG DDP DPC]
#define PLEV			0x08				// reverse Precharge LEVel
#define BVDIG			0x04				// DIGital Voltages
#define DDP				0x02				// Decrement the DP
#define DPC				0x01				// Decrement the PC
